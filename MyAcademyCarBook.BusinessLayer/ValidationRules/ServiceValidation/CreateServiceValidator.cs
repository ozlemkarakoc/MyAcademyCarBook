...
namespace MyAcademyCarBook.BusinessLayer.ValidationRules.ServiceValidation
{
    public class CreateServiceValidator : AbstractValidator<Service>
    {
        ...
        {
            RuleFor(x => x.Title).NotEmpty().WithMessage("Başlığı boş beçemezsiniz!");
            ...
            RuleFor(x => x.Title).MaximumLength(30).WithMessage("Lütfen an fazla 30 karakter veri girişi yapınız!");
